...
def main(parser_data):
    ...
    train_dataset = VOCDataSet(VOC_root, "2010", data_transform["train"], "train.txt")
    train_sampler = None
    ...
    val_dataset = VOCDataSet(VOC_root, "2010", data_transform["val"], "val.txt")
